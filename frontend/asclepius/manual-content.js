  ...
  var REVIEWER = {
    ...
    sections: [
      ...
      },
      {
        id: 'keyboard',
        num: '09',
        chromeLabel: 'DOING IT WITHOUT THE MOUSE',
        title: 'Doing it without the mouse',
        what: 'The whole adjudication is on the keyboard: A, four arrows, Enter.',
        why: 'A clean accept should take under a minute, and reaching for a mouse is most of it.',
