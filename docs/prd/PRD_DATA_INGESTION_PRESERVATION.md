...
- Evidence: `insert_ingest_upload` at backend/asclepius/store.py:5811;
...
- Evidence: `approve_hs_organization` at backend/asclepius/store.py:13353;
  `decline_hs_organization` at backend/asclepius/store.py:13382;
  `record_signed_agreement` at backend/asclepius/store.py:13509;
  `complete_hs_signup` at backend/asclepius/store.py:12821;
...
- Evidence: `unify_patient_keys` at backend/asclepius/ingestion.py:1688;
  ...
  `insert_task` at backend/asclepius/store.py:6999.
