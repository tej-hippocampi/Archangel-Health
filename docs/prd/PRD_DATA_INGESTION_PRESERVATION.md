...
- Evidence: `insert_ingest_upload` at backend/asclepius/store.py:5784;
...
- Evidence: `approve_hs_organization` at backend/asclepius/store.py:13243;
  `decline_hs_organization` at backend/asclepius/store.py:13272;
  `record_signed_agreement` at backend/asclepius/store.py:13399;
  `complete_hs_signup` at backend/asclepius/store.py:12711;
...
- Evidence: `unify_patient_keys` at backend/asclepius/ingestion.py:1688;
  ...
  `insert_task` at backend/asclepius/store.py:6889.
