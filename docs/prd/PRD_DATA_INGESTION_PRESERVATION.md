...
- Evidence: `insert_ingest_upload` at backend/asclepius/store.py:5755;
...
- Evidence: `approve_hs_organization` at backend/asclepius/store.py:13185;
  `decline_hs_organization` at backend/asclepius/store.py:13214;
  `record_signed_agreement` at backend/asclepius/store.py:13341;
  `complete_hs_signup` at backend/asclepius/store.py:12653;
...
- Evidence: `unify_patient_keys` at backend/asclepius/ingestion.py:1688;
  ...
  `insert_task` at backend/asclepius/store.py:6859.
