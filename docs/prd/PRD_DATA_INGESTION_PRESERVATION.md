...
- Evidence: `insert_ingest_upload` at backend/asclepius/store.py:5754;
...
- Evidence: `approve_hs_organization` at backend/asclepius/store.py:13044;
  `decline_hs_organization` at backend/asclepius/store.py:13073;
  `record_signed_agreement` at backend/asclepius/store.py:13200;
  `complete_hs_signup` at backend/asclepius/store.py:12512;
...
- Evidence: `unify_patient_keys` at backend/asclepius/ingestion.py:1688;
  ...
  `insert_task` at backend/asclepius/store.py:6858.
