...
- Evidence: `insert_ingest_upload` at backend/asclepius/store.py:6123;
...
- Evidence: `approve_hs_organization` at backend/asclepius/store.py:13822;
  `decline_hs_organization` at backend/asclepius/store.py:13851;
  `record_signed_agreement` at backend/asclepius/store.py:13978;
  `complete_hs_signup` at backend/asclepius/store.py:13290;
...
- Evidence: `unify_patient_keys` at backend/asclepius/ingestion.py:1729;
  ...
  `insert_task` at backend/asclepius/store.py:7311.
