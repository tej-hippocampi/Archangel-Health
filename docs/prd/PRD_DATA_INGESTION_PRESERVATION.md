...
- Evidence: `insert_ingest_upload` at backend/asclepius/store.py:5803;
...
- Evidence: `approve_hs_organization` at backend/asclepius/store.py:13345;
  `decline_hs_organization` at backend/asclepius/store.py:13374;
  `record_signed_agreement` at backend/asclepius/store.py:13501;
  `complete_hs_signup` at backend/asclepius/store.py:12813;
...
- Evidence: `unify_patient_keys` at backend/asclepius/ingestion.py:1688;
  ...
  `insert_task` at backend/asclepius/store.py:6991.
