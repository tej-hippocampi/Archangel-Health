...
- Evidence: `insert_ingest_upload` at backend/asclepius/store.py:5735;
...
- Evidence: `approve_hs_organization` at backend/asclepius/store.py:13025;
  `decline_hs_organization` at backend/asclepius/store.py:13054;
  `record_signed_agreement` at backend/asclepius/store.py:13181;
  `complete_hs_signup` at backend/asclepius/store.py:12493;
...
- Evidence: `unify_patient_keys` at backend/asclepius/ingestion.py:1688;
  ...
  `insert_task` at backend/asclepius/store.py:6839.
