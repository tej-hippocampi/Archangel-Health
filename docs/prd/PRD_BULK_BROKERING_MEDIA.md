...
10. Completion queues clinical ingestion in the web process at backend/routers/asclepius_provider.py:1444. `process_upload` at backend/asclepius/ingestion.py:1800 scans, unpacks, and builds clinical cases. There is no dedicated media catalog/transfer worker in this path.
