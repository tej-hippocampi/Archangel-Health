...
def _cases() -> list[tuple[str, str, str, str]]:
    return [
        ...
        (
            "26-hs-access", "Health system: portal access",
        ...
        (
            "27-hs-member-added", "Health system: a colleague added you",
        ...
        (
            "28-hs-dla-request", "Health system: one signature away",
        ...
        (
            "29-hs-agreement-receipt", "Health system: the countersigned copy",
        ...
        (
            "30-hs-uploads-open", "Health system: uploads are open",
        ...
        (
            "31-hs-application-alert", "Internal: a health system applied",
