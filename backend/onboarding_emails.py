...
def build_asclepius_rejected_email(*, full_name: str) -> str:
    ...
    is an individual who was told "you'll hear from us within 24 hours" by the
    workspace-ready email, and who otherwise hears nothing while their account
    403s forever with a message about being pending. We already made them a
    promise; silence breaks it, and the limbo is worse than the no.
